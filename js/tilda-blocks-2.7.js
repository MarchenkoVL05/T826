  ...
  function t826_startAnimation(recid) {
    ...
    if (typeof recs !== "undefined" && recs !== null) {
      ...
      Array.prototype.forEach.call(recs, function (rec) {
        ...
        var curGalaxyEl = GalaxyEl.cloneNode(true).style.position = "absolute";
 ...
 */
  function t826_addAnimation(curRec, GalaxyEl, options) {
    ...
    if (curRecType === "396") {
      curRec.querySelector(".t396__filter").insertAdjacentElement('afterend', GalaxyEl);
      ...
      if (coverWrapper) {
        if (coverWrapper.length > 0) {
          coverWrapper.querySelector(".t-cover__filter").insertAdjacentElement('afterend', GalaxyEl);
          GalaxyEl.style.zIndex = "0";
        } else {
          var wrapper = curRec;
          if (wrapper.length === 0) {
          ...
          wrapper.appendChild(GalaxyEl);
          wrapper.style.position = "relative";
          wrapper.querySelector("div").style.position = "relative";
          wrapper.querySelector("div").style.zIndex = "1";
          ...
          if (excludesBlocks.indexOf(parseInt(curRecType, 10)) !== -1) {
            wrapper.querySelector("div").style.zIndex = "";
            GalaxyEl.style.zIndex = "-1";
          } else {
            GalaxyEl.style.zIndex = "0";
          }
